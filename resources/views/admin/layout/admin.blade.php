...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{asset('images/lifewood.png')}}" alt="">
        <span class="d-none d-lg-block">Life Wood</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::routeIs('store.index') ? '' : 'collapsed' }}" href="{{ route('store.index') }}">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Life Wood</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
